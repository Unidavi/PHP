...
$_SG['banco'] = 'linuxstok';            // Banco de dados MySQL
...
function validaUsuario($usuario, $senha) {
    ...
    $resultado = getResultadoGeo($usuario, $senha, $_SG);
...
function getResultadoGeo($usuario, $senha, $_SG){
    $aDadosUsuario = Array();
    $SelecionaUsuario = mysqli_query($_SG['link'], "SELECT * FROM usuarios WHERE usuario = '$usuario' AND senha = '$senha' LIMIT 1");
...
//            $NivelUsuario       = $ResultadoUsuario['nivel'];
            ...
            $aDadosUsuario ['id'] = $ResultadoUsuario['id'];
            $aDadosUsuario ['nome'] = $ResultadoUsuario['nome'];
    }
