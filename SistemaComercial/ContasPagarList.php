            ...
            <div class="bloco list" style="display:block">
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysqli_query($_SG['link'],"SELECT * FROM contaspagar WHERE Identificador LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' AND Status = '0' ORDER BY Id DESC");
						while($ResultadoSelect = mysqli_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['ContasPagar'])){
					  $Resgate = $_GET['ContasPagar'];
					  $Delete = mysqli_query($_SG['link'],"DELETE FROM contaspagar WHERE Identificador = '$Resgate'");
