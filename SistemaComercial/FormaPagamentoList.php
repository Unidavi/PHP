            ...
            <div class="bloco list" style="display:block">
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysqli_query($_SG['link'],"SELECT * FROM formapagamento WHERE Nome LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' ORDER BY Id DESC");
						while($ResultadoSelect = mysqli_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['FormaPagamento'])){
					  $Resgate = $_GET['FormaPagamento'];
					  $Delete = mysqli_query($_SG['link'],"DELETE FROM formapagamento WHERE Identificador = '$Resgate'");
                ...
                <div class="paginator">
                <?php
					$ListTotal = mysqli_query($_SG['link'],"SELECT Id FROM formapagamento WHERE IdUsuario = '$IdUsuario'");
