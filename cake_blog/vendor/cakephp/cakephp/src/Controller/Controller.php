...
use ViewVarsTrait;
    ...
    public function __get($name) {
        if (in_array($name, ['layout', 'view', 'theme', 'autoLayout', 'viewPath', 'layoutPath'], true)) {
            ...
            trigger_error(
                    sprintf('Controller::$%s is deprecated. Use $this->viewBuilder()->%s() instead.', $name, $method), E_USER_DEPRECATED
            );
    ...
    public function __set($name, $value) {
        ...
        if (isset($deprecated[$name])) {
            ...
            trigger_error(
                    sprintf(
                            'Controller::$%s is deprecated. Use $this->viewBuilder()->%s() instead.', $name, $method
                    ), E_USER_DEPRECATED
            );
    ...
    protected function _viewPath() {
        ...
        if (!empty($this->request->params['prefix'])) {
            $prefixes = array_map(
                    'Cake\Utility\Inflector::camelize', explode('/', $this->request->params['prefix'])
            );
