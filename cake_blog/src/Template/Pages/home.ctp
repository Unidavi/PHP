        ...
        <div id="content">
            <div class="row">
                <div class="columns large-12 ctp-warning checks">
                    <a target="_blank" href="../../app_name/Usuarios/">Usuarios</a><br>
                    <a target="_blank" href="../../cake_blog/Articles/">Artigos</a><br>
                    <br><br><br>
                    Please be aware that this page will not be shown if you turn 
                    off debug mode unless you replace src/Template/Pages/home.ctp with your own version.
                </div>
                ...
                <div class="columns large-12 checks">
                    ...
                    <?php if (version_compare(PHP_VERSION, '5.5.9', '>=')): ?>
                        ...
                        < php e se: ?>
                            <p class="problem">Your version of PHP is too low. You need PHP 5.5.9 or higher to use CakePHP (dete ted <?= PHP_VERSION ?>).</p>
                        <?ph  endif; ?>

                 
                       ?php if (extension_loaded('mbst ing')): ?>
